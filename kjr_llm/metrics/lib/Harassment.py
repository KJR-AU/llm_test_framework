...
# Define a class named Harassment that inherits from the Metric class.
class Harassment(Metric):
    
    # Constructor method to initialize the Harassment object.
    def __init__(self):
        # Call the constructor of the parent Metric class with the name "Harassment" and specify that higher values are not better.
